...
module API::V1::Entities
  class DeliveryNote < Base
    ...
    expose :total_quantity, documentation: {type: "Integer", desc: "The gasoline and diesel quantity combined, in liters."} do |note, _opts|
      note.gasoline_quantity + note.diesel_quantity
    end
